        ...
        <section id="product" className={layout.sectionReverse}>
            ...
            <div className={layout.sectionInfo}>
                ...
                <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
                    Lorem ipsum, dolor sit amet consectetur adipisicing elit. Iste tempora aperiam nemo quam eveniet ab id exercitationem, saepe ad dolore inventore aliquid, dolor tenetur deserunt atque, sunt repellendus voluptates maiores?
                </p>
